	...
	<div class="pusher">
		<div class="main-content">
			<div class="ui grid stackable padded">
				<div class="column">
					<form class="ui form" action="admin/suasanpham.htm"  enctype="multipart/form-data" method="post">
						<div class="ui fluid">
							<div class="ui green horizontal label">ID Sản Phẩm</div>
							<form:input path="products.productID" readonly="true" />
						</div>
						<br>
						<div class="ui fluid">
							<div class="ui green horizontal label">Tên Sản Phẩm</div>
							<form:input path="products.name" placeholder="Thêm tên mới ..." />
							<div style='color:red'><form:errors path="products.name" /></div>
						</div>
						<br>
						<div class="ui fluid">
							<div class="ui green horizontal label">Giá Sản Phẩm</div>
							<form:input type="number" path="products.price" placeholder="Thêm giá ..." min="0"/>
						</div>
						<br>
						<div class="ui fluid">
							<div class="ui green horizontal label">Số Lượng</div>
							<form:input type="number" path="products.quatity" placeholder="Thêm số lượng ..." min="0"/>
						</div>
						<br>
						<div class="ui fluid">
						...
						<div>
							...
							<form:select path="products.types.typeID" items="${typest}" itemValue="typeID" itemLabel="typeName"/>
						</div>
						<br>
						<div class="ui green horizontal label">Sản Phẩm có kinh
							doanh hay không ?</div>
						<form:select path="products.available" class="ui dropdown">
